...
test("login,Create and Edit Lead" , async({page}) => {
...
//Fillin all the details neccessary for creating lead
    await page.locator("#createLeadForm_companyName").fill("testleaftechcreate");
           
    await page.locator("#createLeadForm_firstName").fill("PriyaQuality");
    ...
    await page.locator("#updateLeadForm_companyName").fill("testleaftechupdate");

    await page.locator("[name s='submitButton']").first().click();
